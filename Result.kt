...
/**
 * This function executes the passed lambda if the repoListResource is of success type
 * The return type is repoListResource, the same object it is is invoked on, so that you can
...
/**
 * This function executes the passed lambda if the repoListResource is of failure type
 * The return type is repoListResource, the same object it is is invoked on, so that you can
...
/**
 * Converts the given repoListResource into another type
 */
